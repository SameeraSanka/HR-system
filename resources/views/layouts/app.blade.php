...
<head>
    ...
    <link href="{{ asset('assets/vendor/fontawesome-free/css/all.min.cs') }}s" rel="stylesheet" type="text/css">
    <link
    ...
    <link rel="stylesheet" href="{{asset('month/MonthPicker.css')}}">
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Trinity Apparel (pvt) ltd HR 2022</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
...
<script src="{{asset('month/MonthPicker.js')}}"></script>

{{--export to odf--}}
<script src="{{asset('export/tableHTMLExport.js')}}"></script>
